...
var settings = {
	...
	url_dl: "garbage.bin", // path to a large static file, used for download test. must be relative to this js file (kept at repo root because GitHub's web upload maps files to the root directory)
